				...
				<tr><input type="hidden" id="nombre_<?php echo $data['idcliente']; ?>" value="<?php echo $data['nombre']; ?>">
					...
					<td>
						<div class="btn-group" role="group" aria-label="Basic mixed styles example">
							<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModaledit" data-bs-whatever="@mdo" onclick="editar(<?php echo $data['idcliente']; ?>)">
